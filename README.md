...
_All the schematics, PCBs, libraries, and gerber files can be found [here](https://drive.google.com/drive/folders/1gkte6J5BYSigfKPjGuxUxBT0p1oGVBQW)._
...
_All Illustrator files, images used in the display, and Nextion file can be found [here](https://drive.google.com/drive/folders/1Zk3sACVzgEItU8EaXUUS6VA-XOlngmoX)._

### More information
It is possible to see more images and videos of tests carried out in the simulated physical robot during the stage of development of this project [here](https://drive.google.com/drive/folders/1a5xrDm8pRh8xTIRiNfEn4yeEjQZKGxt2).

To see the technical documentation about the communication between robots, obstacle avoidance, path planning, ball localization with camera, robot localization with equally spaced sensors and more check [here](https://github.com/Brenocq/SoccerOpenRCJ/tree/master/Documentation)

**To see all the files in Google Drive together, click [here](https://drive.google.com/drive/folders/1M1GV2yVFg50_pINCr4wT_UaBOKDz4dJr).**
